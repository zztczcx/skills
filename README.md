...
- **[to-spec](./skills/engineering/to-spec/SKILL.md)** — Generate a feature spec (requirements → design → tasks) in kiro or spec-kit format. Slug-based naming, no numbering conflicts.
